                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 font-weight-bold text-success text-uppercase mb-1">
                                            ${title}
<!--                                            <a class="h6 mb-0 font-weight-bold" data-toggle="modal"-->
<!--                                               data-target="#exampleModal">상세보기</a>-->
                                        </div>
                                        <div class="mb-0 font-weight-bold text-gray-800"><a href="${link}" target='_blank'>${link}</a></div>
...
let area0 = ["시/도 선택", "서울특별시", "인천광역시", "대전광역시", "광주광역시", "대구광역시", "울산광역시", "부산광역시", "경기도", "강원도", "충청북도", "충청남도", "전라북도", "전라남도", "경상북도", "경상남도", "제주도", "세종특별자치시"];
...
function searchLocation() {
    let sido = $("select[name=sido1] option:selected").text();
    let gugun = $("select[name=gugun1] option:selected").text();

    let search = sido + " " + gugun
